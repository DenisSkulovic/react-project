        ...
        <div className="container d-flex flex-row flex-wrap justify-content-around">
          <div className="about-wrapper col-11 col-md-9 col-lg-7 col-xl-7 mb-4">
            <div className="about">
              ...
              <p>
                On login the previously anonymous cart is connected to the
                current user.
              </p>
              <p>
                On session expiry the cart is eliminated and cart items are
                returned to the warehouse.
              </p>
              <h4>Checkout</h4>
              <p>
                Once the user leaves their card and shipping details, a request
                is sent to Stripe. On success, the cart items in the backend are
                converted to purchase items and the payment is stored, available
                to later review in case the purchase was authenticated.
              </p>
            </div>
          </div>
